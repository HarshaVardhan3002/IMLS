...
**Analysis**: The coverage drops significantly as \(k\) increases. A single testing scenario (representing the clear daytime urban environment) only covers a small slice of the combinatorial space of dimensions. This demonstrates that our test set is highly inadequate for high \(k\)-projection coverage of the full ODD.
...
We generated Fast Gradient Sign Method (FGSM) attacks against our three CARLA classifiers. 
